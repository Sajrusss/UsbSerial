...
public abstract class UsbSerialDevice implements UsbSerialInterface {
    ...
    static final boolean mr1Version = android.os.Build.VERSION.SDK_INT > android.os.Build.VERSION_CODES.JELLY_BEAN_MR1;
    ...
    public static UsbSerialDevice createUsbSerialDevice(UsbDevice device, UsbDeviceConnection connection, int iface) {
        /*
         * It checks given vid and pid and will return a custom driver or a CDC serial
         * driver.
         * When CDC is returned open() method is even more important, its response will
         * inform about if it can be really
    ...
    public static UsbSerialDevice createUsbSerialDevice(String type, UsbDevice device, UsbDeviceConnection connection,
            int iface) {
        if (type.equals(FTDI)) {
            return new FTDISerialDevice(device, connection, iface);
    ...
    /**
     * <p>
     * Use this setter <strong>before</strong> calling {@link #open()} to override
     * the default baud rate defined in this particular class.
     * </p>
     *
     * <p>
     * This is a workaround for devices where calling {@link #setBaudRate(int)} has
     * no effect once {@link #open()} has been called.
     * </p>
     *
     * @param initialBaudRate baud rate to be used when initializing the serial
     *                        connection
     */
    ...
    /**
     * Classes that do not implement {@link #setInitialBaudRate(int)} should always
     * return -1
     *
